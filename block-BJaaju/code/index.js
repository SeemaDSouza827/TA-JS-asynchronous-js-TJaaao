...
const url =
  'https://api.unsplash.com/photos/?client_id=oBuHi7rXvTfHAZMu9TU9qzpGTUvNUGFOGmg3BD5YVCg';
const GetSearchUrl = (query) => {
  return `https://api.unsplash.com/search/photos/?query=${query}&client_id=oBuHi7rXvTfHAZMu9TU9qzpGTUvNUGFOGmg3BD5YVCg`;
};
